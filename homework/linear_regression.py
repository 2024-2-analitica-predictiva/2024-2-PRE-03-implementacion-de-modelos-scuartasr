# Vamos a crear un modelo de regresión lineal
...
# La forma típica de crearlo es mediante clases para poder empaquetar
# todo lo necesario.

class LinearRegression:
    """Basic linear regression implementation."""

    # El __init__ se corre siempre que se crea una clase
    # Este es el constructor
    def __init__(self, num_epochs=100, learning_rate=0.01):
        # Parámetros del modelo
        # La regresión lineal tiene: los parámetros y la tasa de aprendizaje
        self.coefs_ = None
